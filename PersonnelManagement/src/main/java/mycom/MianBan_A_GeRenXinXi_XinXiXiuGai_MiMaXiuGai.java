...
public class MianBan_A_GeRenXinXi_XinXiXiuGai_MiMaXiuGai extends JPanel implements ActionListener{
	...
	public MianBan_A_GeRenXinXi_XinXiXiuGai_MiMaXiuGai(String id){
		...
		public void queryProcess(String sQueryField)
		{
			try{
				...
				if(rs.next()){
					rs.previous(); 
					while(rs.next()){
						jLSid1=new JLabel(rs.getString("id"));

						jLSname1 =new JLabel(rs.getString("name"));
						jLSsex1=new JLabel(rs.getString("sex"));
						jLSauthority1 =new JLabel(rs.getString("authority"));
						
						jLSDEPARTMENT1 =new JLabel(rs.getString("DEPARTMENT"));
						JLSJOB1 = new JLabel(rs.getString("JOB"));
						jLSEDU_LEVEL1 = new JLabel(rs.getString("EDU_LEVEL"));
						jLSADDRESS1 = new JLabel(rs.getString("ADDRESS"));
						jLSTEL1 =new JLabel(rs.getString("TEL"));
	...
	public static void main(String[] args) {
		...
		new MianBan_A_GeRenXinXi_XinXiXiuGai_MiMaXiuGai("5");
	}
	@Override
